...
def compute_fbank(wav_file,
    ...
    #print("Waveform before: {}".format(waveform))
    waveform = waveform * (1 << 15)
    print("This is waveform size")
    print(waveform.size())
    #print("Waveform after: {}".format(waveform))
...
def main():
    ...
    with open(args.config_file) as f:
        ...
        num_mel_bins = frontend_configs.get("n_mels", 30)
        frame_length = frontend_configs.get("frame_length",20)
